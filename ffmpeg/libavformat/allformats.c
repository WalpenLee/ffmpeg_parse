...
static void av_format_init_next(void)
{
	...
	//outdev_list ø™∑¢’ﬂø…“‘◊‘º∫…Ë÷√£¨”√¿¥◊‘∂®“Â–Ë“™ƒƒ–©muxer
	//µΩ’‚¿Ô ± prevout “—æ≠ «null¡À
    if (outdev_list) {
	...
	//indev_list ø™∑¢’ﬂø…“‘◊‘º∫…Ë÷√£®avpriv_register_devices£©demuxer°£
    if (indev_list) {
...
{
	//±£÷§av_format_init_next÷ªµ˜”√“ª¥ŒÂ 
	//ø‚∫Ø ˝pthread_once() µœ÷“ª¥Œ–‘≥ı ºªØ
    ff_thread_once(&av_format_next_init, av_format_init_next);
}
